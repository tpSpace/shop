...
export const createOrder = async (orderData: OrderRequest, token: string): Promise<Order | null> => {
    try {
...
export const getOrderById = async (orderId: string, token: string): Promise<Order | null> => {
    try {
